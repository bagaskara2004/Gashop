    ...
    <div
        ...
        <div class="w-full">
            <div class="text-center">
                ...
                <p class="mt-2 text-gray-500">Masuk ke akunmu</p>
            </div>
            <div class="mt-5">
                <form action="">
                    ...
                    <p class="text-center text-sm text-gray-500">Tidak memiliki akun?
                        <a href="register"
                            class="font-semibold text-gray-600 hover:underline focus:text-gray-800 focus:outline-none">Daftar
                            sekarang
                        </a>.
                    </p>
                </form>
